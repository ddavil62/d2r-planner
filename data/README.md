...
`아마존`, `원소술사`, `네크로맨서`, `성기사`, `야만용사`, `드루이드`, `암살자`, `악마술사`
8개 직업과 240개 기술을 지원합니다. 추가 6개 직업의 레벨, 선행 기술, 트리 배치는
3.3 원본에서 `npm run data:classes`로 생성하며, 기존 7개 직업의 한국어 이름과 설명은
아이템과 같은 고정 커밋의 `koKR` 문자열을 사용합니다.
